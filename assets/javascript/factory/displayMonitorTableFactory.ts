...
export const displayMonitorTableFactory = function (): CompareTableClass {
  ...
  instance.data.rows.push(
    oneRowFactory(instance, CellType.TEXT_WITH_EVALUATION, '画素数')
  )
  instance.data.rows.push(
  ...
  instance.data.rows.push(
    oneRowFactory(instance, CellType.TEXT_WITH_EVALUATION, '端子')
  )
  instance.data.rows.push(
    oneRowFactory(instance, CellType.TEXT_WITH_EVALUATION, 'スピーカー')
  )
